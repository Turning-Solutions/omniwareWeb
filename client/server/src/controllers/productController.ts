...
// Discount helpers, field stripping, and attribute-group normalisation
 ...
 *  (Delegated to shared utility; kept here for backward-compat imports.) */
// normalizeProductAttributeGroups is now imported from '../utils/discountHelpers'
