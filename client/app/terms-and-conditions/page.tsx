        ...
        <div className="min-h-screen bg-[#121212] text-[#F1F1F1]">
            <div className="mx-auto max-w-4xl px-4 pb-20 pt-10 sm:px-6 lg:px-8">
                <header className="mb-8 border-b border-white/10 pb-6">
                    <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">Terms and Conditions - Omniware</h1>
                    <p className="mt-2 text-sm text-[#B0B0B0]">Last Updated: April 24, 2026</p>
                </header>

                <article className="space-y-6 text-sm leading-7 text-[#D0D0D0] sm:text-base">
                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        <h2 className="text-lg font-semibold text-[#F1F1F1]">1. Introduction</h2>
                        <p className="mt-2">
                            Welcome to Omniware. These Terms and Conditions govern your access to and use of our website and
                            services. By accessing our website or purchasing our products, you agree to be legally bound by
                            these Terms. If you do not agree with any part of these Terms, please discontinue use of our
                            website immediately.
                        </p>
                    </section>

                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        <h2 className="text-lg font-semibold text-[#F1F1F1]">2. Definitions</h2>
                    ...
                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        <h2 className="text-lg font-semibold text-[#F1F1F1]">3. Use of the Website</h2>
                        <p className="mt-2">You agree to use this website only for lawful purposes. Prohibited activities include:</p>
                        <ul className="mt-2 list-disc space-y-1 pl-5">
                    ...
                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        <h2 className="text-lg font-semibold text-[#F1F1F1]">4. Products and Services</h2>
                        <p className="mt-2">
                    ...
                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        <h2 className="text-lg font-semibold text-[#F1F1F1]">5. Pricing and Availability</h2>
                        <ul className="mt-2 list-disc space-y-1 pl-5">
                            <li>
                    ...
                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        <h2 className="text-lg font-semibold text-[#F1F1F1]">6. Orders and Payments</h2>
                        <ul className="mt-2 list-disc space-y-1 pl-5">
                    ...
                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        <h2 className="text-lg font-semibold text-[#F1F1F1]">7. Delivery</h2>
                        <ul className="mt-2 list-disc space-y-1 pl-5">
                            <li>
                    ...
                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        <h2 className="text-lg font-semibold text-[#F1F1F1]">8. Returns and Refunds</h2>
                        <ul className="mt-2 list-disc space-y-1 pl-5">
                            <li>
                    ...
                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        <h2 className="text-lg font-semibold text-[#F1F1F1]">9. Warranty Policy</h2>
                        <p className="mt-2">
                        ...
                        <ul className="mt-2 list-disc space-y-1 pl-5">
                            <li>
                                <span className="font-semibold text-[#F1F1F1]">Exclusions:</span> Warranty does not cover damage
                                caused by misuse, improper installation, physical damage, power surges, or unauthorized repairs.
                            </li>
                        </ul>
                        <p className="mt-3 font-semibold text-[#F1F1F1]">Defined Warranty Periods:</p>
                        <ul className="mt-2 list-disc space-y-1 pl-5">
                    ...
                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        ...
                        <p className="mt-2">If you create an account on our website:</p>
                        <ul className="mt-2 list-disc space-y-1 pl-5">
                    ...
                    <section className="rounded-xl border border-white/10 bg-white/[0.03] p-5 sm:p-6">
                        ...
                        <p className="mt-2">To the maximum extent permitted by law, Omniware shall not be liable for:</p>
                        <ul className="mt-2 list-disc space-y-1 pl-5">
