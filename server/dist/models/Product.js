...
const productSchema = new mongoose_1.default.Schema({
    ...
    brandId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Brand', index: true },
    categoryIds: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Category', index: true }],
